...
function differenceOfSquares(n) {
    let squareSumfOfNumber = 0;
    
    for (let i = 1; i <= n; i++){
      squareSumfOfNumber += i;
    }
    
    squareSumfOfNumber = Math.pow(squareSumfOfNumber, 2);
    
    let sumfOfSquaresOfNumber = 0;
    
    for (let i = 1; i <= n; i++){
      sumfOfSquaresOfNumber += Math.pow(i, 2);
    }
    
    let result = squareSumfOfNumber - sumfOfSquaresOfNumber
